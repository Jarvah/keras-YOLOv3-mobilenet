"""
Retrain the vgg-YOLO model for your own dataset.
"""
...
from yolo3.model_darknet49 import preprocess_true_boxes, yolo_body, tiny_yolo_body, yolo_loss
from yolo3.utils import get_random_data
import matplotlib.pyplot as plt

def _main():
    train_path = 'train_all_ppl.txt'
    #val_path = '2007_test_new.txt'
    log_dir = 'dark49_logs/'
    ...
    if is_tiny_version:
        ...
        model = create_model(input_shape, anchors, num_classes,load_pretrained=False,
                             weights_path='dark49_logs/darknet49_final.h5',
    ...
    if True:
        ...
        model.save_weights(log_dir + 'darknet49_yolo_final.h5')
        model.save(log_dir+'darknet49_model.h5')
